...
WORKFLOW_KEY = "aeheNBQvABl7GxeNpxzqaSIQQEZnxY1YSJ8JHTeV8ks"
WORKFLOW_ID  = "16418d85-967a-45da-99f9-4ccdfb2db047"
BASE_URL     = "https://map-dev.paradigmit.ai/api/v1/agent-workflows"  # change if calling a different environment
...
# ── Step 2: Execute ───────────────────────────────────────────────────────
inputs = {"query": "<value>", "context": "<value>"}
resp = requests.post(
